          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-[#B300FA]/20 bg-purple-50">
                ...
                <th className="text-right py-4 px-4 text-[12px] font-bold text-[#0A0A0A] whitespace-nowrap bg-purple-100/50">结算数量</th>
                <th className="text-right py-4 px-4 text-[12px] font-bold text-[#0A0A0A] whitespace-nowrap bg-purple-100/50">结算金额</th>
            ...
            <tbody>
              {items.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-4 text-[16px] font-bold text-[#B300FA] text-right bg-purple-50/50">{item.settlementQuantity}</td>
                  <td className="py-4 px-4 text-[16px] font-bold text-[#B300FA] text-right bg-purple-50/50">{item.settlementAmount.toLocaleString()}</td>
            ...
            <tfoot>
              <tr className="bg-purple-50 border-t-2 border-[#B300FA]/30">
                ...
                <td colSpan={2} className="py-4 px-4 text-[30px] font-black text-[#B300FA] text-right rounded-br-xl">
